...
app.use([logger, authorize]); //múltiples middlewares, el orden importa, authorize se ejecutará primero si está antes que logger
...
app.get('/api/items', (req, res) => {
  console.log(req.user); //podemos ver a user del middleware authorized
  res.send('Items');
});
